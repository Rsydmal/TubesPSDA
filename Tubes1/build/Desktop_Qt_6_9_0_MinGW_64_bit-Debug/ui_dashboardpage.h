...
public:
    ...
    void setupUi(QWidget *DashboardPage)
    {
        ...
        labelWelcome->setStyleSheet(QString::fromUtf8("image: url(:/images/images/perpusku.jpg)"));
        kelolaDataButton = new QPushButton(DashboardPage);
        kelolaDataButton->setObjectName("kelolaDataButton");
        kelolaDataButton->setGeometry(QRect(570, 730, 201, 51));
        QFont font1;
...
"color: rgb(255, 255, 255);"));
        ...
        label->setGeometry(QRect(560, 740, 201, 51));

    ...
    ui(new Ui::CrudPage)
{
    ...
    wisataList.tambahWisata("Khanoman sang petualang", "2025", "Shanum");
    wisataList.tambahWisata("Efootbal Sang Juara", "2025", "S");
...
void CrudPage::on_tambahWisataButton_clicked() {
    ...
    if (nama.isEmpty() || lokasi.isEmpty() || deskripsi.isEmpty()) {
        QMessageBox::warning(this, "Input Error", "Harap lengkapi semua data buku.");
        return;
    }
...
void CrudPage::on_ubahWisataButton_clicked() {
    ...
    QMessageBox::information(this, "Sukses", "Buku berhasil diubah!");
